...
data_clients = pd.read_excel("../data/clients/NestroStations.xlsx")
...
data_traffic.to_excel("../data/origin/cars_length_procent_NestroStations.xlsx")
...
data_fuel.to_excel("../data/origin/fuel_NestroStations.xlsx")
...
data_das.to_excel("../data/origin/das_NestroStations.xlsx")
