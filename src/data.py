...
roads_df = pd.read_excel("potential.xlsx")
cities_df = pd.read_excel("latlonCities.xlsx")
cities_df['ratio'] = cities_df['Population'] / cities_df['Population'].max()
shopping_malls_df = pd.read_excel("shopping_mall.xlsx")
nestro_stations_df = pd.read_excel("latlonNestroStations.xlsx")
traffic_df = pd.read_excel("traffic.xlsx")
other_stations_df = pd.read_excel("gas_station.xlsx")
