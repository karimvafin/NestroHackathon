...
def get_gas_stations(adress: str, LAT: list):
    url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json"

    params = {
        "location": adress,
        "radius": 50000,
        "type": "gas_station", #["cafe", "supermarket"],
...
def update_gas_stations():
    ...
    for adress in list_adress:
        get_gas_stations_result = get_gas_stations(adress, lat)
        lat = get_gas_stations_result[1]
        gas_stations.extend(get_gas_stations_result[0])
        print("len", len(gas_stations))
    ...
    new_file_path = 'data/origin/gas_station.xlsx'
