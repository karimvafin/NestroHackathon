...
def get_cafe_supermarkets(adress: str, LAT: list):
    url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json"

    params = {
        "location": adress,
        "radius": 50000,
        "type": ["cafe", "supermarket"],
    ...
    return [cafe_supermarkets, LAT]


# Вызовите функцию для получения списка заправок
def update_cafe_supermarkets():
    ...
    for adress in list_adress:
        cafe_supermarkets_result = get_cafe_supermarkets(adress, lat)
        lat = cafe_supermarkets_result[1]
        cafe_supermarkets.extend(cafe_supermarkets_result[0])
        print("len", len(cafe_supermarkets))
    ...
    for diction in cafe_supermarkets:
    ...
    new_file_path = 'data/origin/cafe_supermarket.xlsx'
