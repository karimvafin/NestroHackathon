...
def get_shopping_malls(adress: str, LAT: list):
    url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json"

    params = {
        "location": adress,
        "radius": 50000,
        "type": "shopping_mall",  #["cafe", "supermarket"],
...
def update_shopping_malls():
    ...
    for adress in list_adress:
        get_shopping_malls_result = get_shopping_malls(adress, lat)
        lat = get_shopping_malls_result[1]
        shopping_malls.extend(get_shopping_malls_result[0])
        print("len", len(shopping_malls))
    ...
    new_file_path = 'data/origin/shopping_mall.xlsx'
